...
class KRW extends Currency {
    ...
    public String toString() {
        return String.format("KRW: %.2f %s",super.amount, super.notation);
    }
}
...
class USD extends Currency {
    ...
    @Override
    public String toString() {
        return String.format("USD: %.2f %s",super.amount, super.notation);
    }
}
...
class EUR extends Currency {
    ...
    @Override
    public String toString() {
        return String.format("EUR: %.2f %s",super.amount, super.notation);
    }
}
...
class JPY extends Currency {
    ...
    @Override
    public String toString() {
        return String.format("JPY: %.2f %S",super.amount, super.notation);
    }
}